 ...
 * @const
 */
proto.proto.ModelInfo.repeatedFields_ = [3,5,6];
...
proto.proto.ModelInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    schemaentryList: jspb.Message.toObjectList(msg.getSchemaentryList(),
    proto.proto.SchemaEntry.toObject, includeInstance),
    readonlypathList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? undefined : f
  };
...
proto.proto.ModelInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.proto.SchemaEntry;
      reader.readMessage(value,proto.proto.SchemaEntry.deserializeBinaryFromReader);
      msg.addSchemaentry(value);
      break;
    case 6:
      var value = /** @type {string} */ (reader.readString());
...
proto.proto.ModelInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSchemaentryList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      5,
      f,
      proto.proto.SchemaEntry.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.proto.SchemaEntry>}
 */
proto.proto.ModelInfo.prototype.getSchemaentryList = function() {
  return /** @type{!Array<!proto.proto.SchemaEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.SchemaEntry, 5));
};


/** @param {!Array<!proto.proto.SchemaEntry>} value */
proto.proto.ModelInfo.prototype.setSchemaentryList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 5, value);
};


/**
 * @param {!proto.proto.SchemaEntry=} opt_value
 * @param {number=} opt_index
 * @return {!proto.proto.SchemaEntry}
 */
proto.proto.ModelInfo.prototype.addSchemaentry = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.proto.SchemaEntry, opt_index);
};
 ...
 * Clears the list making it empty but non-null.
 */
proto.proto.ModelInfo.prototype.clearSchemaentryList = function() {
  this.setSchemaentryList([]);
};


/**
 * repeated string readOnlyPath = 6;
 * @return {!Array<string>}
 */
 ...
 * @param {number=} opt_index
 */
proto.proto.ModelInfo.prototype.addReadonlypath = function(value, opt_index) {
