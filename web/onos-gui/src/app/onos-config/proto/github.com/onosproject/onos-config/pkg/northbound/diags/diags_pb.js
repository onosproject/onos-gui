...
goog.exportSymbol('proto.proto.OpStateResponse', null, global);
/**
 ...
 * @constructor
 */
proto.proto.OpStateResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.proto.OpStateResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.OpStateResponse.displayName = 'proto.proto.OpStateResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {boolean}
 */
proto.proto.OpStateRequest.prototype.getSubscribe = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.proto.OpStateRequest.prototype.setSubscribe = function(value) {
 ...
 * @return {!Object}
 */
proto.proto.OpStateResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.OpStateResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.OpStateResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.OpStateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: jspb.Message.getFieldWithDefault(msg, 1, 0),
    pathvalue: (f = msg.getPathvalue()) && github_com_onosproject_onos$config_pkg_northbound_admin_admin_pb.ChangeValue.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.OpStateResponse}
 */
proto.proto.OpStateResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.OpStateResponse;
  return proto.proto.OpStateResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.OpStateResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.OpStateResponse}
 */
proto.proto.OpStateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.proto.Type} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
      var value = new github_com_onosproject_onos$config_pkg_northbound_admin_admin_pb.ChangeValue;
      reader.readMessage(value,github_com_onosproject_onos$config_pkg_northbound_admin_admin_pb.ChangeValue.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.proto.OpStateResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.OpStateResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.OpStateResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.OpStateResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0.0) {
    writer.writeEnum(
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      github_com_onosproject_onos$config_pkg_northbound_admin_admin_pb.ChangeValue.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.proto.OpStateResponse.prototype.getType = function() {
  return /** @type {!proto.proto.Type} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.proto.Type} value */
proto.proto.OpStateResponse.prototype.setType = function(value) {
  jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional ChangeValue pathvalue = 2;
 * @return {?proto.proto.ChangeValue}
 */
proto.proto.OpStateResponse.prototype.getPathvalue = function() {
  return /** @type{?proto.proto.ChangeValue} */ (
    jspb.Message.getWrapperField(this, github_com_onosproject_onos$config_pkg_northbound_admin_admin_pb.ChangeValue, 2));
};


/** @param {?proto.proto.ChangeValue|undefined} value */
proto.proto.OpStateResponse.prototype.setPathvalue = function(value) {
 ...
 */
proto.proto.OpStateResponse.prototype.clearPathvalue = function() {
 ...
 * @return {boolean}
 */
proto.proto.OpStateResponse.prototype.hasPathvalue = function() {
