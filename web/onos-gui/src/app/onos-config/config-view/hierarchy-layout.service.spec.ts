...
describe('HierarchyLayoutService', () => {
    ...
    it('should find root', () => {
        ...
        const nodeC1 = service.ensureNode('/a/b/c1');
        ...
        const nodeC2 = service.ensureNode('/a/b/c2');
        ...
        const nodeD1 = service.ensureNode('/a/b/c2/d1');
        ...
        expect(service.flatMap.get('/a').y).toEqual(200);
